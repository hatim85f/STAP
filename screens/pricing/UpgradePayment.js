...
const UpgradePayment = (props) => {
  ...
  const submitHandler = () => {
    props.navigation.navigate("Make_Upgrade", {
      packageId: packageId,
      type: packageType,
      email: user.email,
        ...
        {packageDetails && (
          <View style={styles.pacakgeContainer}>
            ...
            <Text style={styles.note}>
              ...
              what you will get. Remianing Amount from previous subscription (
              if any ) will be deducted from the total amount.
            </Text>
